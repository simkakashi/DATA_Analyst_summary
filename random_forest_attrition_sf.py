...
data = pd.read_excel(r'/Users/guoxiujun/Documents/Raw_Data/Attrition_Model/Attrition_2/data_clean_0607.xlsx')
...
classifier = RandomForestClassifier(n_estimators = 87, criterion = 'gini', random_state = 100, max_features=200)
...
importance_csv.to_csv(r'/Users/guoxiujun/Documents/ANALYSIS/Attrition_Model/variables_importance_sf.csv',index=False,sep=',')
##group by name
...
importance_temp.to_csv(r'/Users/guoxiujun/Documents/ANALYSIS/Attrition_Model/variables_importance_group_sf.csv',index=False,sep=',')
##
#store the model
joblib.dump(classifier, 'random_forest_attrition_sf.pkl')
...
plt.savefig(r'/Users/guoxiujun/Documents/ANALYSIS/Attrition_Model/Variables_Scatter_sf.png')
